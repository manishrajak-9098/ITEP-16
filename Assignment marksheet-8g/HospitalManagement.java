...
class Patient {
    ...
    void setData(int i) {
        ...
        while (age<=0){
        System.out.println("Enter age of patient again its Invalid !!");
        age = sc.nextInt();
...
class HospitalManagement {
    public static void main(String args[]) {
        ...
        int nP = sc.nextInt();
        while (nP<=0){
        System.out.println("Invalid no. Enter no of patients Again:! ");
         nP = sc.nextInt();
        }
        ...
        int nD = sc.nextInt();
         while (nD<=0){
        System.out.println("Invalid no. Enter no of Docter Again:! ");
         nD = sc.nextInt();
        ...
        int nM = sc.nextInt();
         while (nM<=0){
        System.out.println("Invalid no. Enter no of Medicines Again:! ");
         nM= sc.nextInt();
